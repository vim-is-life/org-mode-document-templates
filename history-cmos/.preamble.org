# In my CMoS essays, I generally don't need a TOC or section numbering. Moreover,
...
# CMoS says documents should have 1in margins and typically be TNR font.
...
#+LATEX_HEADER_EXTRA:   \lhead{\@author}
#+LATEX_HEADER_EXTRA:   \chead{}
#+LATEX_HEADER_EXTRA:   \rhead{\thepage}
...
# To make paragraph length and bibliography hanging indent compliant
